...
public class CombineDataframe {
    public static void main(String[] args) {
        CombineDataframe app = new CombineDataframe();
        app.start();
    }
    ...
    private void start(){
        ...
        Dataset<Row> wakeRestaurantDf = buildWakeRestaurantsDataframe(spark);
        Dataset<Row> durhamRestaurantDf = buildDurhamRestaurantsDataframe(spark);
    ...
    private Dataset<Row> buildWakeRestaurantsDataframe(SparkSession spark) {
    ...
    private Dataset<Row> buildDurhamRestaurantsDataframe(SparkSession spark){
